...
define void @_Z6serialPfi(float* %A, i32 %N) #0 {
entry:
  ...
  store float -9.999900e+04, float* %ma, align 4
  store float -9.999900e+04, float* %mi, align 4
  store float -9.999900e+04, float* %m, align 4
...
cond.true:                                        ; preds = %if.then
  %12 = load float, float* %ma, align 4
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  store float %cond, float* %ma, align 4
  %19 = load float, float* %mi, align 4
...
cond.true18:                                      ; preds = %cond.end
  %26 = load float, float* %mi, align 4
...
cond.end25:                                       ; preds = %cond.false22, %cond.true18
  ...
  store float %cond26, float* %mi, align 4
  br label %if.end

if.else:                                          ; preds = %for.body
  %33 = load float, float* %mi, align 4
...
cond.true33:                                      ; preds = %if.else
  %40 = load float, float* %mi, align 4
...
cond.end40:                                       ; preds = %cond.false37, %cond.true33
  ...
  %47 = load float, float* %ma, align 4
...
cond.true48:                                      ; preds = %cond.end40
  %54 = load float, float* %ma, align 4
